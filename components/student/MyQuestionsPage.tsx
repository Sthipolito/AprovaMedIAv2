        ...
        if (courses.length === 0) {
            return (
                <div className="text-center py-20">
                    ...
                    <h2 className="text-xl font-semibold text-gray-700">Nenhuma Questão Disponível</h2>
                    <p className="text-gray-500 mt-2 max-w-md mx-auto">
                        Parece que ainda não há conjuntos de questões no seu curso. Assim que forem adicionados, eles aparecerão aqui.
                    </p>
                </div>
            );
        }
        ...
        <>
            <div className="h-full w-full flex flex-col bg-gray-50 overflow-y-auto">
                <header className="p-6 border-b border-gray-200 bg-white">
                    <h1 className="text-3xl font-bold text-gray-800">Minhas Questões</h1>
