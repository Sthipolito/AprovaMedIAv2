        ...
        if (structuredBank.length === 0) {
             return (
                 <div className="text-center py-20">
                    ...
                    <h2 className="text-xl font-semibold text-gray-700">Seu Banco de Estudos está vazio</h2>
        ...
        <>
            <div className="h-full w-full flex flex-col bg-gray-50 overflow-y-auto">
                <header className="p-6 border-b border-gray-200 bg-white flex justify-between items-center flex-wrap gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800">Banco de Estudos</h1>
                        <p className="text-gray-500 mt-1">Navegue, gerencie e responda às questões de estudo salvas.</p>
                    </div>
                    <div>
                        {selectedStudent ? (
